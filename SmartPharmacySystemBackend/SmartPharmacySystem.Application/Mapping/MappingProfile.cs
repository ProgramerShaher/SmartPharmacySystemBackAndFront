    ...
    public class MappingProfile : Profile
    {
      ...
      .ForMember(dest => dest.BatchNumber, opt => opt.MapFrom(src => src.Batch != null ? src.Batch.CompanyBatchNumber : string.Empty));
            ...
            CreateMap<StockTransfer, StockTransferDto>()
                ...
                .ForMember(dest => dest.SourceBranchId, opt => opt.MapFrom(src => src.SourceWarehouse != null ? src.SourceWarehouse.BranchId : (int?)null))
                ...
                .ForMember(dest => dest.DestinationBranchName, opt => opt.MapFrom(src => src.DestinationWarehouse != null && src.DestinationWarehouse.Branch != null ? src.DestinationWarehouse.Branch.Name : (src.DestinationBranch != null ? src.DestinationBranch.Name : string.Empty)))
                .ForMember(dest => dest.DestinationBranchId, opt => opt.MapFrom(src => src.DestinationBranchId ?? (src.DestinationWarehouse != null ? src.DestinationWarehouse.BranchId : (int?)null)))
