...
{
    /// <inheritdoc />
    public partial class AddPurchaseOrdersSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<bool>(
                name: "AllowPurchaseOrders",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConvertedPurchaseInvoiceId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_PurchaseInvoices_ConvertedPurchaseInvoiceId",
                        column: x => x.ConvertedPurchaseInvoiceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderDetails_MedicineUnits_SaleUnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderDetails_SaleUnitId",
                table: "PurchaseOrderDetails",
                column: "SaleUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_ConvertedPurchaseInvoiceId",
                table: "PurchaseOrders",
                column: "ConvertedPurchaseInvoiceId");
