...
public interface IMonthlySalaryService
{
    ...
    Task<MonthlySalaryDto> PaySalaryAsync(int id, PaySalaryDto dto, int? userId = null);
    Task<int> PayAllAsync(int month, int year, int? branchId, PaySalaryDto dto, int? userId = null);
}
