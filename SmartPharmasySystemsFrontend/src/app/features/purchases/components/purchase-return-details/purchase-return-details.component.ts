...
@Component({
  ...
  styleUrls: ['./purchase-return-details.component.scss'],
  providers: [ConfirmationService],
})
export class PurchaseReturnDetailsComponent implements OnChanges {
  ...
  invoice: PurchaseReturn | null = null;
  loading = false;
  ...
  approveInvoice() {
    ...
    this.confirmationService.confirm({
      message:
        'هل أنت متأكد من اعتماد هذا المرتجع؟ سيتم خصم الكميات من المخزون.',
  ...
  cancelInvoice() {
    ...
    this.confirmationService.confirm({
      message:
        'تحذير: هل أنت متأكد من إلغاء هذا المرتجع؟ سيتم إعادة الكميات إلى المخزون.',
